              ...
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 w-full sm:w-auto">
                <div className="relative flex-1 sm:flex-none">
                  ...
                  <Input
                    ...
                    className={`h-10 pl-8 w-full sm:w-48 md:w-64 transition-colors ${mounted && theme === 'dark' ? 'bg-slate-700 dark:border-slate-600 dark:text-white' : ''}`}
                  />
                </div>
                <div className="flex items-center gap-2">
                  <Select value={statusFilter} onValueChange={setStatusFilter}>
                    <SelectTrigger className={`h-10 flex-1 sm:w-32 md:w-48 ${mounted && theme === 'dark' ? 'bg-slate-700 dark:border-slate-600 dark:text-white' : ''}`}>
                  ...
                  <Button
                    variant="outline"
                    className="h-10 shrink-0 text-red-600 hover:text-red-700 hover:bg-red-50 dark:hover:bg-red-900/20 disabled:opacity-50 disabled:cursor-not-allowed"
